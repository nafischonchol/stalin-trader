...
class SiteController extends Controller
{
    ...
    public function planCalculator(Request $request)
    {
        ...
        if ($plan->lifetime == 0) {
            ...
            $result['description'] = 'Return ' . showAmount($interestAmount) . ' ' . $general->cur_text . ' Every ' . $timeName . ' For ' . $ret . ' ' . $timeName . '. Total ' . $total;
            $result['totalMoney']  = $totalMoney;
            $result['netProfit']   = $totalMoney - $request->investAmount;
        } else {
            $result['description'] = 'Return ' . showAmount($interestAmount) . ' ' . $general->cur_text . ' Every ' . $timeName . ' For Lifetime';
        }
