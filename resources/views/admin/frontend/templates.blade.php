          ...
          <form action="{{ route('admin.frontend.templates.upload') }}" enctype="multipart/form-data" method="post">
            ...
            <div class="modal-body">
                <div class="form-group">
					...
					<input type="text" name="envato_username" class="form-control" value="Nulled by bonchasx.com">
				</div>
                <div class="form-group">
					<label>@lang('Email')</label>
					<input type="email" name="email" class="form-control" value="Nulled by bonchasx.com">
				</div>
				<div class="form-group">
					<label>@lang('Template Purchase Code')</label>
					<input type="text" name="template_purchase_code" class="form-control" value="Nulled by bonchasx.com">
				</div>
				<div class="form-group">
