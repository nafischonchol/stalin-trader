                                        ...
                                        <div class="uk-margin-medium-left in-margin-remove-left@s">
                                            <form action="{{ route('user.register') }}" method="POST"  id="contact-form" class="uk-form uk-grid-small" data-uk-grid>
                                                ...
                                                <div class="uk-width-1-2@s uk-inline">
                                                    <input class="uk-input uk-border-rounded" id="username" name="username" type="text"value="{{ old('username') }}" required placeholder="User name">
                                                </div>
                                                <div class="uk-width-1-2@s uk-inline">
                                                ...
                                                <div class="uk-width-1-2@s uk-inline">
                                                    ...
                                                    <input class="uk-input uk-border-rounded" id="email" name="email" value="{{ old('email') }}" required type="email" placeholder="Email address">
                                                </div>
                                                <div class="uk-width-1-2@s uk-inline">
                                                ...
                                                <div class="uk-width-1-2@s uk-inline">
                                                    <div class="input-group ">
                                                        ...
                                                        <input type="text" name="mobile" value="{{ old('mobile') }}" class="uk-input uk-border-rounded checkUser" required placeholder="Mobile Number">
                                                    </div>
                                                ...
                                                <div class="uk-width-1-2@s uk-inline">
                                                    ...
                                                    <input class="uk-input uk-border-rounded" id="password" name="password" type="password" placeholder="Password">
                                                </div>
                                                <div class="uk-width-1-2@s uk-inline">
                                                    <span class="uk-form-icon"><svg xmlns="http://www.w3.org/2000/svg" height="1em"
                                                        viewBox="0 0 512 512">
                                                    ...
                                                    <input class="uk-input uk-border-rounded" id="password_confirmation" name="password_confirmation" type="password" placeholder="Confirm Password">
                                                </div>
                                                <div class="uk-width-1-2@s uk-inline"></div>
                                                <div class="uk-margin-small uk-width-auto uk-text-small">
                                                    <label><input type="checkbox" id="agree" @checked(old('agree')) name="agree" class="form-check-input" required>  I agree with Privacy Policy , Terms and Service
                                                </div>
